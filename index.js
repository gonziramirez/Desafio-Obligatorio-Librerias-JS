...
const cargarProductos =(array)=> {
    ...
    if (array.length !== 0){
        ...
        array.forEach(producto => {
            productos = `<div class="d-flex flex-column align-items-center text-center">
...
const filtrarProductos=()=>{
    ...
    if (buscar.value !== ""){
        ...
        resultado.length === 0 ? contenedorProductos.innerHTML = `<h5>No se encontro el producto</h5>` : cargarProductos(resultado)
    }
    else{
